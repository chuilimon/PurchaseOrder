<?php
/**
 * Products, Quotations & si modules.
...
$dictionary['AOS_PO'] = array(
 ...
 'aos_po_aos_si' =>
  ...
  'name' => 'aos_po_aos_si',
  'type' => 'link',
  'relationship' => 'aos_po_aos_si',
  'source' => 'non-db',
  'module'=>'AOS_si',
 ),
 'aos_po_aos_contracts' =>
  array (
  'name' => 'aos_po_aos_contracts',
  'type' => 'link',
  'relationship' => 'aos_po_aos_contracts',
  'source' => 'non-db',
  'module'=>'AOS_Contracts',
 ),
 'aos_products_po' =>
  array (
  'name' => 'aos_products_po',
    'type' => 'link',
    'relationship' => 'aos_po_aos_product_po',
    'module'=>'AOS_Products_po',
    'bean_name'=>'AOS_Products_po',
    'source'=>'non-db',
 ),
	...
	'aos_po_aos_product_po' =>
	array (
	'lhs_module'=> 'AOS_po', 
	'lhs_table'=> 'aos_po', 
	'lhs_key' => 'id',
	'rhs_module'=> 'AOS_Products_po', 
	'rhs_table'=> 'aos_products_po', 
	'rhs_key' => 'parent_id',
...
VardefManager::createVardef('AOS_po','AOS_po', array('basic','assignable'));
